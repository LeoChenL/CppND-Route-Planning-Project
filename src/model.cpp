...
// static means this function only visi in this file
...
/*
Parse .osm file
initialize m_Nodes, m_Ways, ... m_Landuses
*/
...
/*
change the coordinate of nodes
lat/lon -> x/y(m)
origin: osm map min lat/lon
*/
...
void Model::BuildRings( Multipolygon &mp )
{
    ...
    auto process = [&]( std::vector<int> &ways_nums ) {
        auto ways = m_Ways.data(); // ways = a pointer to the first element in m_Ways
